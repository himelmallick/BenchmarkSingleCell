...
inputDirectory<-paste(workDirectory,'Input_Islam_ZI',sep='/')
...
stopCluster(cl)
outputDirectory<-paste(workDirectory,paste('Outputs',SourceData,'ZI',sep='_'),sep="/")
