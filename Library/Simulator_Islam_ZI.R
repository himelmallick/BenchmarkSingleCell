...
dropout.mid<-as.numeric(input["dropout.mid"])
...
OutDirectory<-file.path(workDirectory,paste('Input',SourceData,'ZI',sep='_'))
...
pdf(inputplotR,width=9,height=6)
par(mfrow=c(2,3))
...
plot.info<-paste("(Cells = ",nCells,", Genes = ",nGenes,", Added Zero = ","Yes",
...
plot(b,ylab="Number of Genes",main=" Technical Zero",
     xlab="Fraction Zero",col="steelblue")
