################################################################
# Vanilla Gamma regression (gamma) with Library Size as Offset #
################################################################
...
############################
# Fit gamma To A Dataset #
############################

fit.gamma <- function(features, 
                   metadata, 
                   libSize, 
                   ID, 
                   transformation,
...
###################################
# Fit gamma To A List of Datasets #
###################################

list.gamma<-function(physeq, transformation = 'NONE', multiple_qvalues = TRUE){
  foreach(physeq = physeq, 
          ...
          .errorhandling = "remove") %dopar% 
    {
      ...
      ID<-physeq$ID
      DD<-fit.gamma(features, metadata, libSize, ID, transformation, multiple_qvalues)
