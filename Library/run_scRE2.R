...
##########################
# Fit scRE2 To A Dataset #
##########################

fit.scRE2 <-function(features, 
                    metadata, 
                    libSize, 
                    ID, 
                    transformation,
...
###################################
# Fit scRE2 To A List of Datasets #
###################################

list.scRE2<-function(physeq, transformation = 'NONE', multiple_qvalues = TRUE){
  foreach(physeq = physeq, 
          ...
          .errorhandling = "remove") %dopar% 
    {
      ...
      ID<-physeq$ID
      DD<-fit.scRE2(features, metadata, libSize, ID, transformation, multiple_qvalues)
